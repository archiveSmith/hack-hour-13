...
function commonElements(array1, array2, array3, array4){
  ...
  const longArr = (() => {
    if (array1.length === lenOfArs) return array1;
    if (array2.length === lenOfArs) return array2;
    if (array3.length === lenOfArs) return array3;
    if (array4.length === lenOfArs) return array4;
  })();
