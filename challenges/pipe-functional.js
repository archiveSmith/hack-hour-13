...
const H = (letters) => letters.length < 0 || letters === undefined ? 'H' : `H${letters}`;
...
const e = (letters) => letters.length < 0 || letters === undefined ? 'e' : `e${letters}`;

const l = (letters) => letters.length < 0 || letters === undefined ? 'l' : `l${letters}`;

const o = (letters) => letters.length < 0 || letters === undefined ? 'o' : `o${letters}`;
